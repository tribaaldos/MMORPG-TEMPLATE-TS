...
import GreenPortalLevaControls from './GreenPortalLevaControls';

interface GreenPortalShaderControls {
  scaleProp?: number;
...
export default function GreenPortalShader({
  scaleProp = 1.0,
  position = [0, 0, 0],
  colorA: colorAProp = '#0af83a',
  ...
  return (
    <>
      {location.pathname === '/shader-visualizer/2' && (
        <GreenPortalLevaControls
          key={controlsKey}
          setColorA={setColorA}
          setColorB={setColorB}
          setScale={setScale}
